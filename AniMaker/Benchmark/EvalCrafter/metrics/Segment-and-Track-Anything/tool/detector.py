...
class Detector:
    def __init__(self, device):
        config_file = "Benchmark/EvalCrafter/metrics/Segment-and-Track-Anything/src/groundingdino/groundingdino/config/GroundingDINO_SwinT_OGC.py"
        grounding_dino_ckpt = 'Benchmark/EvalCrafter/checkpoints/ckpt/groundingdino_swint_ogc.pth'
