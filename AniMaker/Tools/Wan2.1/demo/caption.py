...
if __name__ == "__main__":
    ...
    video_path = "Pipeline/res/85/w13w25/videos/scene_3/clip_3/enhanced/scene_3_clip_3_pregen_from_scene3_clip2_node3_iter1_outx4.mp4"
    output_path = "Tools/Wan2.1/demo/outputs/85-3-3_outx4_captioned.mp4"
    caption_text = "Finished drawing, Bunny proudly holds up his artwork. \"Look what we created!\""
