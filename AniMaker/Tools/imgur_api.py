...
class Imgur:
    ...
    def upload_image(self, image_path, album_id='F4SknEo'):
...
# imgur_api = Imgur(client_id='your client_id here', client_secret='your client_secret here',
#                 access_token='your access_token here', refresh_token='your refresh_token here')
# imgur_api.upload_image('Pipeline/imgs/characters/Little_Prince/img.jpg')
# imgur_api.upload_image('Pipeline/imgs/environments/Icy_Desert_Night/Icy_Desert_Night.png')
# imgur_api.download_image('LfJv9HW')