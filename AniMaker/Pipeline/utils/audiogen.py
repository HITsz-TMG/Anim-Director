...
from Tools.CosyVoice.cosyvoice.cli.cosyvoice import CosyVoice, CosyVoice2
from Tools.CosyVoice.cosyvoice.utils.file_utils import load_wav
...
class CosyVoiceGenerator:
    ...
    def generate_voiceover_script(self, force_generate=False):
        ...
        2. Format all lines using the pattern: [emotion:voice_type] content, where:
           ...
           - voice_type is one of: narrative, boy, girl, youngman, youngwoman, woman, man, elderly
        ...
        4. For character dialogue, wrap spoken words in <speak>[emotion:voice_type] </speak> tags and use:
           ...
           Only words directly spoken by characters in the script should be wrapped in <speak>[emotion:voice_type] </speak> tags.
           Note that [emotion:voice_type] for the spoken words must be enclosed within <speak> </speak> tags.
        ...
        Directly give the voice-over script without any guide words or markdown. Do not mark the serial number.
        """
        ...
        while iterations < max_iterations:
            ...
            if lines_to_fix:
                for idx, original_line, content, word_count, reason in lines_to_fix:
                    ...
                    3. For character dialogue, wrap spoken words in <speak>[emotion:voice_type] </speak> tags and use:
                        - "boy" for boy characters
                        - "girl" for girl characters
                        - "youngman" for young male characters
                        - "youngwoman" for young female characters
                    ...
                    Directly give the adjusted line without any guide words or markdown. Do not mark the serial number.
                    """
